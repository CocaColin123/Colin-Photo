...
export default function MusicWidget({ registerSfxApi, duckDb = 0 }: MusicWidgetProps) {
  ...
  return (
    <button
      ...
      className="fixed left-5 bottom-5 z-[120] select-none"
      style={{
        width: 46,
        height: 46,
    ...
    >
      <span
        aria-hidden
        className="absolute -top-1 left-1/2 -translate-x-1/2 text-[16px] font-bold pointer-events-none"
        style={{
      ...
      <span
        aria-hidden
        className="absolute inset-0 rounded-[6px] border flex items-center justify-center"
        style={{
